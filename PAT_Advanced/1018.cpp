...
int Cmax,N,Sp,M;
int Matrix[501][501] = {0},dist[501],weight[501];//weight指节点自行车数量与节点半容量Cmax/2的差
bool visited[501];
int minSend = INFI,minBack = INFI;
vector<int> preNode[501],path,tempPath;
...
int main(){
    fill(Matrix[0],Matrix[0]+501*501,INFI);
    fill(dist,dist+501,INFI);
